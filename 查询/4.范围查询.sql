--in (1,3,8)表示在一个非连续的范围内
    ...
    select name from studuent where age in (12, 18, 34);

--not in不非连续的范围内
    --不是年龄为18， 34的人信息
    select name from studuent where age not in (12, 18, 34);
...
--between ... and ...表示在什么范围之内  属于连续问题查询
    ...
    --不再范围
    select name from studuent where age not between 12 and 34;
    select name from studuent where not age between 12 and 34;
